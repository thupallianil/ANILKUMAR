    ...
    <div>
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-gray-800">
          Fashion {subcategory && <span className="text-pink-600">› {subcategory}</span>}
        </h2>
        {subcategory && (
          <Link to="/products/Fashion" className="text-pink-500 hover:underline text-sm mt-1 inline-block">
            ← View All Fashion
          </Link>
        )}
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <Link to="/products/Fashion" className="text-pink-600 hover:underline mt-2 inline-block">
            Browse All Fashion
          </Link>
        </div>
      ) : (
          ...
          {products.map((product) => (
            ...
            >
              ...
              <Link to={`/product/${product.id}`}>
                <h3 className="text-lg font-semibold text-center hover:text-pink-600 transition-colors">{product.name}</h3>
              </Link>
